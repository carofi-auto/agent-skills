---
name: feature-brief
description: Use when feature discovery is complete and an execution-ready plan is needed. Triggers after /feature-discovery or equivalent thorough requirement exploration produces a locked set of decisions, cleared risks, and defined success metrics. Do NOT use when critical unknowns remain — stop and run /feature-discovery first.
---
...
**In:** Explicit list of what's included in this brief.
...
If this list is non-empty, assess whether any item is a blocker for Phase 1 execution. If yes, resolve before shipping the brief.
...
- If a section of the brief is thin because discovery was thin, say so. Don't pad.
- Short is better than comprehensive if comprehensive means vague.

**What good looks like:** Someone reads this brief, doesn't meet with you, and can start executing Phase 1 tasks by end of day. If they'd have questions after reading, the brief isn't done.
